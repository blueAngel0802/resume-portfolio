...
export type Service = { title: string; whoItsFor: string; includes: string[]; typicalTimeline: string };
...
export const portfolio = {
  ...
  proof: <ProofMetric[]>[
    { label: "App speed", value: "+45%", note: "React + state management optimization" },
    { label: "Latency", value: "-35%", note: "Front-end performance + rendering fixes" },
    { label: "Build time", value: "-30%", note: "Tooling improvements (Vite/Webpack)" },
    { label: "Mentorship", value: "Team impact", note: "Coaching + code review standards" }
  ],
  ...
  projects: <ProjectTemplate[]>[
    {
      ...
      oneLiner: "Turn a slow React app into a fast, smooth UX with measurable wins.",
      problem: "Users experienced sluggish interactions and inconsistent performance across pages.",
      approach: [
      ...
      stack: ["React", "TypeScript", "Redux/State", "Lighthouse", "Vite/Webpack"],
      links: [
    ...
    },
    {
      ...
      kind: "Job-style",
      oneLiner: "Build a consistent UI library to speed up feature delivery and reduce bugs.",
      problem: "Inconsistent UI patterns slowed delivery and increased regressions.",
      approach: [
      ...
      stack: ["React", "TypeScript", "Material UI (or custom)", "Testing Library/Jest"],
    ...
    },
    {
      ...
      problem: "Slow builds and flaky CI made releases painful and reduced iteration speed.",
      approach: [
  ...
  process: <Step[]>[
    { title: "1) Discovery", detail: "Clarify goals, constraints, and success metrics." },
    { title: "2) Plan", detail: "Propose milestones, scope, and technical approach." },
    { title: "3) Build", detail: "Ship in small PRs with clear communication." },
    { title: "4) QA & Polish", detail: "Test critical flows, performance check, edge cases." },
    { title: "5) Launch", detail: "Deploy + hand-off docs + next-step recommendations." }
  ],

  // Experience: SHORT. Resume is a download.
  experienceHighlights: [
    { company: "RVO Health", role: "Senior Software Engineer", dates: "2021–2025", bullets: ["Improved app speed by ~45% via React + state optimizations.", "Reduced latency ~35% and helped raise code quality through mentoring."] },
    { company: "Brandbassador", role: "Senior Full Stack Engineer", dates: "2017–2020", bullets: ["Built and maintained React features and API integrations.", "Improved build efficiency (target ~30%) through tooling work."] },
    { company: "Kryptos", role: "Software Engineer", dates: "2012–2016", bullets: ["Shipped React/TypeScript UI features with responsive design.", "Partnered with designers to translate UX into production UI."] }
  ]
};
